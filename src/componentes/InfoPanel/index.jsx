...
const funcionalidades = [
    { id: 1, nome: 'checkcircle', imagemSrc: CheckCircleIcon, texto: 'Encontre os melhores profissionais' },
    { id: 2, nome: 'calendar', imagemSrc: CalendarIcon, texto: 'Gerencie a sua agenda com facilidade' },
    { id: 3, nome: 'creditcard', imagemSrc: CreditCardIcon, texto: 'Pagamentos seguros e rápidos' },
    { id: 4, nome: 'staricon', imagemSrc: StarIcon, texto: 'Avaliações e confiança' },
]
...
function Funcionalidade() {
    ...
    const funcionalidadeAtiva = funcionalidades.find(item => item.id === idAtivo);
